...
<head>
  ...
  <title>ReTyme - Find study partners around the world!</title>
</head>
    ...
    <div class="container">
      ...
      <div class="topics">
        ...
        <ul class="topics__list">
          ...
          <li>
            <a href="python.php">Python <span>232</span></a>
          </li>
          <li>
            <a href="javascript.php">JavaScript <span>122</span></a>
          </li>
          <li>
            <a href="react.php">React <span>57</span></a>
          </li>
          <li>
            <a href="room.php">Database <span>90</span></a>
          </li>
        </ul>
        <button class="btn btn--link" href="./topics.php">
          More
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
            <title>chevron-down</title>
            <path d="M16 21l-13-13h-3l16 16 16-16h-3l-13 13z"></path>
      ...
      <div class="roomList">
        <div class="profile">
          ...
          <div class="profile__about">
            <h3>About</h3>
            <p>
              Hi, I am web programmer, and programmer in the world, I work in internet, so I know python, javascript, php, html, css, bootstrap, create logo tips and others, but they can use those languages.
            </p>
          </div>
        </div>
        ...
        <div class="roomListRoom">
          ...
          <div class="roomListRoom__content">
            ...
            <p>
              You can learn 100 days of coding challenge, it will be useful to yourself
            </p>
          </div>
          <div class="roomListRoom__meta">
            ...
            <p class="roomListRoom__topic">100 days coding</p>
          </div>
        </div>
        <div class="roomListRoom">
          <div class="roomListRoom__header">
          ...
          <div class="roomListRoom__content">
            ...
            <p>
              Javscript made simle, and difficult for people. It is for websites.
            </p>
          </div>
          <div class="roomListRoom__meta">
      ...
      <div class="activities">
        ...
        <div class="activities__box">
          ...
          <div class="activities__boxContent">
            <p>100 coding to post “<a href="room.php">100 Days of code challenge!</a>”</p>
            <div class="activities__boxRoomContent">
              I’ll have to try this sometime. Really like this code. Dennis talk about it? I ‘m....
            </div>
          </div>
        </div>
      </div>
