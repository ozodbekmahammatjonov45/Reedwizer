    ...
    <nav>
        <div class="left">
            ...
            <div class="search_bar">
                ...
                <input type="text" placeholder="Search Reedwizer">
...
<div class="center" style="text-decoration:none">
        ...
        <div class="right">
            ...
            <a href="" style="text-decoration:none;color:#000"><i class="fa-brands fa-facebook-messenger"></i></a>
    ...
    <div class="main">
        ...
        <a href="profile.php" style="text-decoration:none;color: #fff;">
           ...
           <a href="Friends/friend.php" style="text-decoration: none;list-style: none;">
             <div class="img">
                <img src="image/friend.png">
                <p style="color:#fff; ">Friends</p>
            </div>

           </a>
            <a href="save.php" style="color: white;text-decoration: none;">
                <div class="img">
            ...
            <a href="Friends/friend.php"style="color: white;text-decoration: none;">
           ...
           <a href="watch.php" style="color: white;text-decoration: none;">
             <div class="img">
            ...
            <a href="./eduweb-master/index.php" style="text-decoration: none; color: white;">
                <div class="shortcuts">
      ...
      <!--       <div class="top_box">
            ...
            <div class="friends_post">
                ...
                <img src="image/shortcuts_5.webp">
                <div style="margin: -10% 10% 10% 20rem;"><button style="padding: 10px 50px; cursor: pointer; border: 1px solid blue;background: none;color: white;border-radius: 5px;">Bu Now 700$</button></div>
                <div class="info">
                    ...
                    <div class="emoji_img">
                        ...
                        <p>You, Coray 7 and 30K others</p>
                    </div>
            ...
            <div class="loard">
                <button>Add More Things to Market</button>
            </div>

            <p class="end">Design By<span><i class="fa-regular fa-face-grin"></i>
            WT ozodbek Code</span></p>
