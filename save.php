...
<div class="center" style="text-decoration:none">
       ...
       <div class="right">
            ...
            <a href="./Chat/index.php" style="text-decoration:none;color:#000"><i class="fa-brands fa-facebook-messenger"></i></a>
    ...
    <div class="main">
      ...
      <a href="save.php" style="color:#fff;text-decoration: none;">
      	      <div class="img">
 ...
 -->
       <!--      <div class="friends_post">
            ...
            <div class="loard">
                <button>Add More your things</button>
            </div>
