...
<div class="center" style="text-decoration:none; margin: 0 0 0 20%">
    ...
    <div class="images_of_story">
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/contact_4.jpg" style="height:60vh">
        </div>
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/contact_1.jpg"style="height:60vh">
        </div>
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/profile_10.png"  style="height:60vh" >
        </div>
        
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/profile_12.jpg" style="height:60vh" >
        </div>
    </div>
