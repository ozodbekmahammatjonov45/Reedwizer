...
<html lang="en">
  <head>
    ...
    <title>Reedwizer - Find study partners around the world!</title>
  </head>
...
<!--          <h1>BOOVKMREM</h1>-->
      ...
      <div class="container">
        ...
        <div class="topics">
          ...
          <ul class="topics__list">
            <li>
              <a href="profile.php" class="active">All <span>553</span></a>
            </li>
       <!--      <li>
              <a href="python.html">Python <span>232</span></a>
            </li> -->
             <li>
              <a href="javascript.php">React <span>122</span></a>
            </li>
            <li>
        ...
        <div class="roomList">
          ...
          <div class="roomList__header">
            <div>
              <h2>React Room</h2>
              <p>7,439 Python Rooms available</p>
            </div>
          ...
          <div class="roomListRoom">
            ...
            <div class="roomListRoom__content">
              <a href="room.php">React made Simple Projects</a>
              <p>
            ...
            <div class="roomListRoom__meta">
              ...
              <p class="roomListRoom__topic">React</p>
            </div>
          </div>
          <div class="roomListRoom">
            <div class="roomListRoom__header">
            ...
            <div class="roomListRoom__content">
              <a href="room.php">React new Aplications</a>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ducimus harum dolorem, obcaecati
                mollitia omnis quasi aut consequuntur enim itaque labore.
              </p>
 ...
 <div class="roomListRoom">
            ...
            <div class="roomListRoom__content">
              <a href="room.php">simple websites in react </a>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ducimus harum dolorem, obcaecati
                mollitia omnis quasi aut consequuntur enim itaque labore.
              </p>
  ...
  <div class="roomListRoom">
            <div class="roomListRoom__header">
              <a href="profile.htmphpl" class="roomListRoom__author">
                <div class="avatar avatar--small active">
                  <img src="https://randomuser.me/api/portraits/men/18.jpg" />
                </div>
                <span>@Robert_mask</span>
              </a>
              <div class="roomListRoom__actions">
            ...
            <div class="roomListRoom__content">
              <a href="room.php">React JS coder</a>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ducimus harum dolorem, obcaecati
                mollitia omnis quasi aut consequuntur enim itaque labore.
              </p>
