...
<div class="center" style="text-decoration:none; margin: 0 0 0 20%">
    ...
    <div class="images_of_story">
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/post_2.jpg" style="height:62vh">
        </div>
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/post_3.png"style="height:62vh">
        </div>
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/story_3.jpg"  style="height:62vh" >
        </div>
        
        <div class="story_img" style="width:100%;height:50vh;">
            <img src="image/profile_12.jpg" style="height:62vh" >
        </div>
    </div>
